...
import com.twixttechnologies.tjss.view.activity.CheckInListingActivity;
import com.twixttechnologies.tjss.view.adapter.listadapter.SafetyCircleMembersListingAdapterForCheckIn;
    ...
    private Observer<SafetyCircleMember[]> mSafetyCircleMembersObserver
        ...
        public void onChanged(@Nullable SafetyCircleMember[] safetyCircleMembers) {
            ...
            SafetyCircleMembersListingAdapterForCheckIn adapter
                    = new SafetyCircleMembersListingAdapterForCheckIn(
                    new ArrayList<>(Arrays.asList(safetyCircleMembers)), getActivity(), FragmentSafetyCircleMembersListing.this);
