...
import com.twixttechnologies.tjss.view.activity.ViewPlanDetailsActivity;
import com.twixttechnologies.tjss.view.fragment.payment.FragmentPurchaseBase;
import com.twixttechnologies.tjss.view.fragment.plans.FragmentViewPlanDetails;
import com.twixttechnologies.tjss.viewmodel.PlansViewModel;
    ...
    private Observer<List<Plan>> mPlansListObserver
        ...
        public void onChanged(@Nullable List<Plan> plans) {
            ...
            for (int i = 0; i < plans.size(); i++) {
                ...
                planFee.setText(plan.planPrice);
