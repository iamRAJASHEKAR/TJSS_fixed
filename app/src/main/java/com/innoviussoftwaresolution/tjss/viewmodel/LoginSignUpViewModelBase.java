...
//                        editor=preferences.edit();
                        Log.d("fname",result.fname);
                        PreferenceHelper.saveString(getApplication(), PreferenceHelper.KEY_FIRST_NAME, result.fname);
                        PreferenceHelper.saveString(getApplication(), PreferenceHelper.KEY_LAST_NAME, "");
                        ...
                        PreferenceHelper.saveString(getApplication(),PreferenceHelper.USER_ROLE,result.role);
                        PreferenceHelper.saveString(getApplication(),PreferenceHelper.ISD_CODE,result.isdcode);
...
//                        editor.commit();
                        ...
                        if(PreferenceHelper.getString(getApplication(),PreferenceHelper.USER_ROLE,"").equalsIgnoreCase("service provider"))
                        {
                            PreferenceHelper.saveBoolean(getApplication(), PreferenceHelper.PROVIDER_LOGIN, true);
                        }
                        else
                        {
