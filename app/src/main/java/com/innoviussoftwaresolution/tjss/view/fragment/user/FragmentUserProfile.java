...
import com.innoviussoftwaresolution.tjss.view.activity.DeleteAccountActivity;
...
import com.innoviussoftwaresolution.tjss.view.fragment.user.alert.FirstAndLastNameDialog;
import com.innoviussoftwaresolution.tjss.view.viewutils.Permissions;
import com.innoviussoftwaresolution.tjss.viewmodel.UserProfileViewModel;
...
public class FragmentUserProfile extends BaseFragment implements PermissionsDetailListDialog.PermissionsDialogCallback, FirstAndLastNameDialog.OnNameUpdateListener {
    ...
    AppCompatTextView mCboUserProfileIsdCodes;
...
//            }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mLblUserProfileFirstName.setText(PreferenceHelper.getString(getActivity(),PreferenceHelper.KEY_FIRST_NAME,""));
        mLblUserProfileLastName.setText(PreferenceHelper.getString(getActivity(),PreferenceHelper.KEY_LAST_NAME,""));
        mLblUserProfileEmail.setText(PreferenceHelper.getString(getActivity(),PreferenceHelper.KEY_EMAIL,""));
        mLblUserProfileEmail2.setText(PreferenceHelper.getString(getActivity(),PreferenceHelper.KEY_EMAIL,""));
        mLblUserProfilePhone.setText(PreferenceHelper.getString(getActivity(),PreferenceHelper.KEY_PHONE,""));
        String isdCode=PreferenceHelper.getString(getActivity(),PreferenceHelper.ISD_CODE,"");
        mCboUserProfileIsdCodes.setText("+"+isdCode);
