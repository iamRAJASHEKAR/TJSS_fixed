...
import com.innoviussoftwaresolution.tjss.view.activity.AccountSettingsActivity;
import com.innoviussoftwaresolution.tjss.view.activity.AlertOptionsSettingsActivity;
import com.innoviussoftwaresolution.tjss.view.activity.LoginOrSignUpActivity;
import com.innoviussoftwaresolution.tjss.view.activity.MapSettingsActivity;
import com.innoviussoftwaresolution.tjss.view.activity.MedicalRecordsActivity;
import com.innoviussoftwaresolution.tjss.view.activity.SafetyCircleSettingsActivity;
import com.innoviussoftwaresolution.tjss.view.activity.SafetyTipsSettingsActivity;
import com.innoviussoftwaresolution.tjss.view.activity.ServiceProviderSelectionActivity;
...
public class FragmentSettings extends SettingsFragmentBase {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        String name = PreferenceHelper.getString(activity, PreferenceHelper.KEY_FIRST_NAME, "")+" "
                + PreferenceHelper.getString(activity, PreferenceHelper.KEY_LAST_NAME, "");
        ...
        preferences = getActivity().getSharedPreferences("firebase",0);
    ...
    public void onBtnLogoutClicked() {
       ...
       // String firebaseId = PreferenceHelper.getString(getActivity(),"firebaseId","");
        //editor.commit();
