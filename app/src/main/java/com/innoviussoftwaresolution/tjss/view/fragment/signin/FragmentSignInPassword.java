...
import com.innoviussoftwaresolution.tjss.model.network.request.ForgotPasswordRequest;
...
import com.innoviussoftwaresolution.tjss.view.fragment.signin.alert.FragmentForgotPasswordDialog;
    ...
    public void onSubmit(String email) {
        ...
        new ForgotPasswordRequest(TjssNetworkInterface.class, new RequestCallback<StatusMessage>() {
            ...
            public void onSuccess(StatusMessage result) {
                ...
                if (result != null) {
                    if (result.status != null) {
                        if (result.status.equalsIgnoreCase("success")) {
                            M.showAlert(getActivity(), "Success", "An email has been sent to you with your new password. Use new password to login.", "OK",
                                    null, null, null, false);
                        } else {
                            M.showAlert(getActivity(), "Error", result.status, "OK",
                                    null, null, null, false);
                        }
                    }
                }
                ...
                {
                    M.showAlert(getActivity(), "Error", "An error occurred, Please try again latter", "OK",
                            null, null, null, false);
                }
            }
            ...
            {
                M.showAlert(getActivity(), "Forgot Password", "An error occurred, Please try again latter",
