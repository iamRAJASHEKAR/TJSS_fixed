...
public class FragmentAddSafetyCircle extends BaseFragment {
    ...
    @BindView(R.id.safetyCircleNameFamily)
    AppCompatButton mSafetyCircleNameFamily;
    ...
    @OnClick({R.id.safetyCircleNameFriends, R.id.safetyCircleNameColleagues,
            ...
            R.id.safetyCircleNameSpecialPersons, R.id.safetyCircleNameFamily,R.id.btnDone})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.safetyCircleNameFamily:
