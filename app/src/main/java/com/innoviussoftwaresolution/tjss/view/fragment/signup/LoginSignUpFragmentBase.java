    ...
    protected Observer<SignUpAndLoginResponse> mSignUpResponseObserver
        ...
        public void onChanged(@Nullable SignUpAndLoginResponse signUpByInviteCodeResponse) {
            ...
            if (signUpByInviteCodeResponse == null) {
                ...
                String userRole = PreferenceHelper.getString(getContext(), PreferenceHelper.USER_ROLE, "");
                if (userRole.equalsIgnoreCase("service provider")) {
                    PreferenceHelper.saveBoolean(getActivity(), PreferenceHelper.PROVIDER_LOGIN, true);
                    Intent intent = new Intent(getActivity(), ServiceProviderHome.class);
