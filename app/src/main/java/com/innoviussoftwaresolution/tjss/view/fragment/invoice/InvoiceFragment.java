...
public class InvoiceFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView =(RecyclerView)view.findViewById(R.id.recy_user_invoice_list);
        return view;
            ...
            public void onResponse(Call<TaskResponce> call, Response<TaskResponce> response) {
                ...
                if (response != null){
                    ...
                    for (int i = 0; i < response.body().taskList.size(); i++) {
                        if (response.body().taskList.get(i).getTaskStatus().equalsIgnoreCase("1")) {
                    ...
                    adaptor = new InvoiceAdaptor(getContext(), requestList);
