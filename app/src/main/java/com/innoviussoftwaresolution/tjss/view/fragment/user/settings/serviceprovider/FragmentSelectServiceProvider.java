...
import com.innoviussoftwaresolution.tjss.view.adapter.listadapter.AppServiceProviderAdapter;
import com.innoviussoftwaresolution.tjss.viewmodel.ServiceProviderSettingsViewModel;
...
public class FragmentSelectServiceProvider extends ServiceProviderSelectionFrgamentBase {
    ...
    public void onViewClicked() {
        ...
        if (selectedIds == null || selectedIds.equals("") || selectedIds.equals(",")) {
            ...
            editor.putString("serviceProviderId",selectedIds);
            editor.commit();
           // Toast.makeText(getContext(),selectedIds,Toast.LENGTH_LONG).show();
