...
public class HelpAlertIncidentLogAdapter$LogViewHolder_ViewBinding implements Unbinder {
  private HelpAlertIncidentLogAdapter.LogViewHolder target;

  @UiThread
  public HelpAlertIncidentLogAdapter$LogViewHolder_ViewBinding(HelpAlertIncidentLogAdapter.LogViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    HelpAlertIncidentLogAdapter.LogViewHolder target = this.target;
