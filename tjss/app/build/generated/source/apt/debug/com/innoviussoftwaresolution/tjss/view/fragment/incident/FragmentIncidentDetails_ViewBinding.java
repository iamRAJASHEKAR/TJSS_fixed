...
public class FragmentIncidentDetails_ViewBinding extends BaseFragment_ViewBinding {
  private FragmentIncidentDetails target;

  @UiThread
  public FragmentIncidentDetails_ViewBinding(FragmentIncidentDetails target, View source) {
    super(target, source);
  ...
  @Override
  public void unbind() {
    FragmentIncidentDetails target = this.target;
