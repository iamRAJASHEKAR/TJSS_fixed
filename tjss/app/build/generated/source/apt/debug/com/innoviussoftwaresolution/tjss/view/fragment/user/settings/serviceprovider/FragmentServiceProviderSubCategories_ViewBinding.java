...
public class FragmentServiceProviderSubCategories_ViewBinding extends BaseFragment_ViewBinding {
  private FragmentServiceProviderSubCategories target;

  private View view2131755496;

  @UiThread
  public FragmentServiceProviderSubCategories_ViewBinding(final FragmentServiceProviderSubCategories target,
      View source) {
    super(target, source);
  ...
  @Override
  public void unbind() {
    FragmentServiceProviderSubCategories target = this.target;
