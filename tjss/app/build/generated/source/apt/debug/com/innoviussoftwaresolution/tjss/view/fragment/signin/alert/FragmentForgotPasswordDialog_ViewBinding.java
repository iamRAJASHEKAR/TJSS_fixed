...
package com.innoviussoftwaresolution.tjss.view.fragment.signin.alert;
...
public class FragmentForgotPasswordDialog_ViewBinding implements Unbinder {
  private FragmentForgotPasswordDialog target;

  private View view2131755408;

  @UiThread
  public FragmentForgotPasswordDialog_ViewBinding(final FragmentForgotPasswordDialog target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    FragmentForgotPasswordDialog target = this.target;
