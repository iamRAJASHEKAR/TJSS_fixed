...
public class FragmentServiceProviderCategories_ViewBinding extends BaseFragment_ViewBinding {
  private FragmentServiceProviderCategories target;

  private View view2131755496;

  @UiThread
  public FragmentServiceProviderCategories_ViewBinding(final FragmentServiceProviderCategories target,
      View source) {
    super(target, source);
  ...
  @Override
  public void unbind() {
    FragmentServiceProviderCategories target = this.target;
